...
export class Checkout extends PureComponent {
    ...
    stepMap = {
        [SHIPPING_STEP]: {
            ...
            url: '/shipping',
            progressBarTag: 'Shipping',
            objectTag: SHIPPING_STEP,
        ...
        [BILLING_STEP]: {
            ...
            url: '/billing',
            progressBarTag: 'Billing',
            objectTag: BILLING_STEP,
    ...
    render() {
        return (
            <main block="Checkout">
                <ProgressBar
                    steps={[
                        this.stepMap[SHIPPING_STEP],
                        this.stepMap[BILLING_STEP],
                        this.stepMap[DETAILS_STEP]
                    ]}
